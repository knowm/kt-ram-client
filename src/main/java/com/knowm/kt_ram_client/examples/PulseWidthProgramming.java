...
import com.knowm.kt_ram_client.utils.programming.VariableWidth;

public class PulseWidthProgramming extends HostInfo {
	...
	static float targetResistance = 350_000;// ohms
	...
	public static void main(String[] args) {
		...
		try {
			...
			VariableWidth programmer = new VariableWidth(client);
			programmer.setTargetResistance(targetResistance);
			programmer.setTolerance(tolerance);
			programmer.setMaxSteps(200);
			programmer.setMonitorSamplePeriod(60);
			programmer.setMonitorTotalTimeInSeconds(60 * 60);
			/*
			 * @formatter:off
			 * 
			...
			// lrs_hrs = doc.measureLrsHrs(.3f, 50000, .15f, 10000, column, row, true);

			programmer.setActivation(new Activation(module, unit, array, column, row));
			programmer.program();
			programmer.plotHistory();
