...
import com.knowm.kt_ram_client.utils.programming.VoltageSweep;

public class VoltageSweepProgramming extends HostInfo {
	...
	static float targetResistance = 500_000;// ohms
	...
	public static void main(String[] args) {
		...
		try {
			...
			VoltageSweep programmer = new VoltageSweep(client);
			programmer.setTargetResistance(targetResistance);
			programmer.setTolerance(tolerance);
			programmer.setMaxSteps(100);
			programmer.setMonitorSamplePeriod(5);
			programmer.setMonitorTotalTimeInSeconds(60);
			/*
			 * @formatter:off
			 * 
